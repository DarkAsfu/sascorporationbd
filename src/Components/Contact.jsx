...
const Contact = () => {
  return (
    ...
    // </div>
    <>
      <div id="contact" className="min-h-screen  justify-center bg-white mb-8">
        <Title title="Contact Us" />
        <div className="max-w-7xl mx-4 md:mx-auto md:border-2 border-gray-300 rounded-3xl overflow-hidden flex flex-col lg:flex-row mt-10">
          ...
          <div className="lg:w-1/2 p-8 flex flex-col justify-center relative">
            ...
            <ul className="space-y-4">
              <li className="flex items-center">
                <IoLocationOutline className="text-gray-500 mr-2 text-3xl" />
                <span className="text-gray-600">
                  149/A, Airport Road, Baitush Sharraf Mosjid Complex, Suit-106
                  (1st Flr) Dhaka-Tejgaon, 1215, BD
                </span>
              </li>
              <li className="flex items-center">
                <LuPhoneCall className="text-gray-500 mr-2" />
                <span className="text-gray-600"> 880241040033</span>
              </li>
              <li className="flex items-center">
                <FaFacebookF className="text-gray-500 mr-2" />
          ...
          <div className="lg:w-1/2 p-8 bg-[#E7E9ED] relative rounded-3xl  md:m-20">
            ...
            <form className="relative space-y-6">
              ...
              <div>
                <Button className="w-full py-3 px-6 bg-white border-none text-[#0073E6]  font-semibold text-[16px] hover:bg-[#0073E6] hover:text-white ">
                  Submit
                </Button>
              </div>
            </form>
